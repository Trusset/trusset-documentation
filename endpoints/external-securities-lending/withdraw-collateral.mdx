...
| `PRICE_STALE` | `400` | The loan carries debt and the oracle price is outside the market's `maxPriceAge`. Push a NAV with [Sync Oracle Price](/endpoints/external-securities-lending/sync-oracle), or supply a `signedPrice` |
