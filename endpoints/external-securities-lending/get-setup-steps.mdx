...
<ResponseField name="data" type="object">
  <Expandable>
    ...
    <ResponseField name="relayerAddress" type="string">Instance relayer. Oracle signer and liquidator role checks are evaluated against this address. When null, the liquidator step can never report done.</ResponseField>
...
<Tip>
  `grantLiquidatorRole` can be executed directly through [Set Liquidator Role](/endpoints/external-securities-lending/set-liquidator-role) when the instance relayer holds the market admin role.
</Tip>
  ...
  "data": {
    ...
    "steps": [
      {
        ...
        "title": "Grant the freeze adapter the agent role on the collateral token",
        "done": false,
      ...
      },
      {
        ...
        "title": "Verify the liquidation router on the identity registry",
        "done": false,
      ...
      },
      {
        ...
        "title": "Authorize the instance relayer as an oracle signer",
        "done": true,
      ...
      },
      {
        ...
        "title": "Grant the instance relayer LIQUIDATOR_ROLE on the market",
        "done": false,
    ...
    "calldata": {
      ...
      "verifyRouterAsHolder": {
        "to": "0x9e3c...1145",
        "data": "0x...",
        "description": "Verify the liquidation router on the identity registry"
      },
      "grantLiquidatorRole": {
