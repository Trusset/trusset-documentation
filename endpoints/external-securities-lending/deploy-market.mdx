...
<ParamField body="borrowAssetAddress" type="string">
  Settlement token (stablecoin) for the market. Any ERC-20 with 6 to 18 decimals, validated on-chain. Omit to use USDC. Cannot be changed after deployment.
</ParamField>
...
Confirming can also return any [transaction verification error](/endpoints/introduction#confirming-a-transaction).
