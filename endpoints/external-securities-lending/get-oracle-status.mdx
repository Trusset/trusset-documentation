...
<ResponseField name="data" type="object">
  <Expandable>
    ...
    <ResponseField name="signerAddress" type="string">Instance relayer address, or null when no relayer is configured. Conditional on `configured`.</ResponseField>
    <ResponseField name="signerAuthorized" type="boolean">Whether the instance relayer can push and sign prices for this oracle.</ResponseField>
