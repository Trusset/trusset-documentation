...
Returns a single auction with its live price. Unlike [List Active Auctions](/endpoints/lending/list-auctions), this returns closed and expired auctions too, with `active` set to `false`.
...
<ResponseField name="data" type="object">
  <Expandable>
    ...
    <ResponseField name="venueAddress" type="string">The market's auction module, lowercased. This is the contract the auction lives on, and the one a bid targets.</ResponseField>
  </Expandable>
</ResponseField>
