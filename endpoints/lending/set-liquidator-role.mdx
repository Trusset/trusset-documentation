...
Grants or revokes `LIQUIDATOR_ROLE` for any address on the market contract. Holding this role is a prerequisite for [Liquidate Loan](/endpoints/lending/liquidate) and [Settle Expired Auction](/endpoints/lending/settle-expired-auction).
