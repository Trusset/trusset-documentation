...
Reports whether the market has indexed history and how far behind the chain the index currently sits. Use it to decide whether [Get Market History](/endpoints/lending/get-history) is trustworthy before charting it, and to tell "no activity" apart from "not indexed yet".
