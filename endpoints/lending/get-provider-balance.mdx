...
<ResponseField name="data" type="object">
  <Expandable>
    <ResponseField name="shares" type="string">LP shares held, formatted at 18 decimals. Pass this to [Remove Liquidity](/endpoints/lending/remove-liquidity).</ResponseField>
