...
<CardGroup cols={2}>
  ...
  <Card title="MiCA Register" icon="building" href="/endpoints/mica-register/introduction">
  ...
  <Card title="Trading" icon="chart-line" href="/endpoints/stock-trading/introduction">
  ...
  <Card title="Lending" icon="building-columns" href="/endpoints/lending/introduction">
    Lending markets collateralized by imported ERC-3643 security tokens. Deploy freeze or custody markets, publish NAV pricing, set rate modes and loan terms, manage liquidity and loans, and run the operator-driven liquidation settlement workflow.
  </Card>
  <Card title="Asset Register" icon="book" href="/endpoints/asset-register/introduction">
  ...
  <Card title="Vaults" icon="vault" href="/endpoints/vaults/introduction">
